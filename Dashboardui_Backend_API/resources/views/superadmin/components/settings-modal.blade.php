...
<div id="superadminSettingsModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 hidden" 
     style="background: rgba(0, 0, 0, 0.5); backdrop-filter: blur(4px);">
    
    <!-- Modal Content -->
    <div id="superadminSettingsModalContent" 
         class="relative w-full max-w-md superadmin-card rounded-2xl shadow-2xl transform transition-all duration-300 scale-95 opacity-0"
        ...
        <div class="flex items-center justify-between p-6 border-b" style="border-color: var(--border-color);">
            ...
            <button id="closeSuperadminSettingsBtn" 
        ...
        <div class="p-6 space-y-8">
            ...
            <div>
                ...
                <div class="space-y-3">
                    ...
                    <button data-language-link="{{ $code }}"
                            ...
                            onclick="window.location.href='{{ route_with_lang('superadmin.dashboard', [], $code) }}'">
            ...
            <div>
                ...
                <div class="flex space-x-3">
                    <button id="superadminLightThemeBtn" 
                    ...
                    <button id="superadminDarkThemeBtn" 
                            class="flex-1 flex items-center justify-center p-4 rounded-xl transition-all duration-200 hover:scale-105"
                            style="background: var(--background-color); border: 1px solid var(--border-color); color: var(--text-color);">
                        <div class="text-center">
