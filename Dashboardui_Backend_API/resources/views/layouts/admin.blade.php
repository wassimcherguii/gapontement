...
<head>
    ...
    <title>@yield('title', get_translation('admin_dashboard')) - {{ get_company_name() }} {{ get_company_tagline() }}</title>
    <meta name="description" content="@yield('description', get_translation('admin_dashboard_description'))">
    ...
    <!-- Critical CSS -->
    @include('admin.components.critical-css')
...
<body class="min-h-screen" style="background: var(--background-color); color: var(--text-color);">
    ...
    <!-- Settings Modal -->
    @include('admin.components.settings-modal')
