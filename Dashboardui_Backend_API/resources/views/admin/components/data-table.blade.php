...
<div class="admin-card rounded-xl overflow-hidden">
    ...
    <div class="p-6 border-b" style="border-color: var(--border-color);">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0 {{ is_rtl_language(app()->getLocale()) ? 'md:flex-row-reverse' : '' }}">
            ...
            <div class="flex items-center space-x-3 {{ is_rtl_language(app()->getLocale()) ? 'space-x-reverse' : '' }}">
                <button class="px-4 py-2 text-sm font-medium rounded-lg border transition-colors duration-200 admin-hover"
    ...
    <div class="px-6 py-4 border-t flex items-center justify-between {{ is_rtl_language(app()->getLocale()) ? 'flex-row-reverse' : '' }}"
        ...
        <div class="flex-1 flex justify-between sm:hidden">
            <button class="relative inline-flex items-center px-4 py-2 border text-sm font-medium rounded-md transition-colors duration-200 admin-hover"
                    style="border-color: var(--border-color); color: var(--text-color);">
                {{ get_translation('previous') }}
            </button>
            <button class="ml-3 relative inline-flex items-center px-4 py-2 border text-sm font-medium rounded-md transition-colors duration-200 admin-hover"
                    style="border-color: var(--border-color); color: var(--text-color);">
        ...
        <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            ...
            <div>
                <nav class="relative z-0 inline-flex rounded-md shadow-sm -space-x-px" aria-label="Pagination">
                    <button class="relative inline-flex items-center px-2 py-2 rounded-l-md border text-sm font-medium transition-colors duration-200 admin-hover"
                            style="border-color: var(--border-color); color: var(--text-color);">
                    ...
                    <button class="relative inline-flex items-center px-4 py-2 border text-sm font-medium transition-colors duration-200 admin-hover"
                            style="border-color: var(--border-color); color: var(--text-color);">
                        2
                    </button>
                    <button class="relative inline-flex items-center px-4 py-2 border text-sm font-medium transition-colors duration-200 admin-hover"
                    ...
                    <button class="relative inline-flex items-center px-2 py-2 rounded-r-md border text-sm font-medium transition-colors duration-200 admin-hover"
                            style="border-color: var(--border-color); color: var(--text-color);">
